...
[_NAV] = LAYOUT_preonic_grid(
  ...
  KC_NO,  C(KC_A),   KC_NO,     KC_NO,     KC_NO,     KC_NO,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_NO,   LCA(KC_DEL),
  KC_DEL, C(KC_Z),   C(KC_X),   C(KC_C),   C(KC_V),   KC_TRNS, KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, KC_UP,   KC_NO,
