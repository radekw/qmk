...
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  KC_BSPC, RSFT_T(KC_A), KC_S,    KC_D,     KC_F,  KC_G,   KC_H,   KC_J,  KC_K,    KC_L,    RSFT_T(KC_SCLN), KC_QUOT,
  KC_LSFT, LCTL_T(KC_Z), KC_X,    KC_C,     KC_V,  KC_B,   KC_N,   KC_M,  KC_COMM, KC_DOT,  RCTL_T(KC_SLSH), SC_SENT,
