...
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  KC_ESC,  KC_A,        KC_S,        KC_D,  KC_F,    LT(1,KC_G), LT(2,KC_H), KC_J,   KC_K,    KC_L,          KC_SCLN,        KC_QUOT,
  KC_LSFT, CTL_T(KC_Z), ALT_T(KC_X), KC_C,  KC_V,    LT(4,KC_B), KC_N,       KC_M,   KC_COMM, ALT_T(KC_DOT), CTL_T(KC_SLSH), KC_RSFT,
  MO(4),   KC_LGUI,     KC_NO,       LOWER, KC_BSPC, KC_ENT,     KC_SPC,     KC_SPC, RAISE,   KC_NO,         KC_NO,          KC_NO
),
...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  KC_NO,   KC_NO,  KC_NO,  LOWER,  KC_DEL, KC_ENT, KC_SPC,  KC_P0,  RAISE,  KC_PDOT,  KC_NO,      KC_NO
),
...
[_RAISE] = LAYOUT_preonic_grid (
  ...
  KC_NO,   KC_NO,   KC_NO,   LOWER,   KC_DEL,  KC_ENT,  KC_SPC, KC_SPC,  RAISE,   KC_NO,   KC_NO,      KC_NO 
),
...
[_NAV] = LAYOUT_preonic_grid(
  ...
  KC_TRNS, KC_NO,     KC_NO,     KC_NO,     KC_NO,     KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_LEFT, KC_DOWN, KC_RGHT
)
};
