 ...
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |Shitf |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Crtl | GUI  | Alt  |      |Lower |    Space    |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  KC_LCTL, KC_LGUI, KC_LALT, KC_NO,   LOWER,   KC_PMNS, KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,           RSFT_T(KC_RGHT)
),
...
[_LOWER] = LAYOUT_preonic_grid(
  KC_TILD, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_NO, KC_LPRN, KC_RPRN, KC_DEL,
  ...
  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_TRNS, KC_UNDS, KC_SPC,  MO(3), KC_P0, KC_PDOT, KC_NO,   KC_NO
),
...
[_RAISE] = LAYOUT_preonic_grid (
  ...
  KC_NO,   KC_NO,   KC_NO,   KC_NO,   MO(3),   KC_UNDS, KC_SPC, KC_TRNS, KC_NO,   KC_NO,   KC_NO,    KC_NO
),
