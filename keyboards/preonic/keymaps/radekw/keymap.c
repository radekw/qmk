...
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  KC_LSFT, CTL_T(KC_Z), KC_X,    KC_C,  KC_V,    LT(4,KC_B), KC_N,       KC_M,   KC_COMM, ALT_T(KC_DOT), CTL_T(KC_SLSH), KC_RSFT,
  KC_LCTL, KC_NO,       KC_LALT, LOWER, KC_BSPC, KC_ENT,     KC_SPC,     KC_SPC, RAISE,   KC_LGUI,       KC_NO,           KC_NO
),
