...
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  KC_LCTL, KC_NO,  KC_LALT, MO(_NAV), LOWER, KC_ENT, KC_SPC, RAISE, MO(_SYMB), KC_LGUI, KC_NO,     KC_RCTL
),
...
[_ADJUST] = LAYOUT_preonic_grid(
  ...
  BACKLIT, QK_BOOT, DB_TOGG, CG_TOGG, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
...
[_SYMB] = LAYOUT_preonic_grid(
  ...
  KC_NO, KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,  KC_NO, KC_RGHT
)
};
