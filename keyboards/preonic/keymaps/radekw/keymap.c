...
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  KC_LCTL, KC_LCMD, KC_LALT, L_FN, L_NAV, KC_ENT, KC_SPC, L_NUM, L_SYM,   KC_LGUI, KC_RCMD, KC_RCTL
),
...
[_GAME] = LAYOUT_preonic_grid(
  ...
  KC_LCTL, KC_NO, KC_LALT, L_FN, L_NAV, KC_SPC, KC_SPC, L_NUM, L_SYM,   KC_LGUI, KC_NO,   KC_RCTL
),
[_NUM] = LAYOUT_preonic_grid(
  KC_GRV,  KC_NUM,  KC_NO, KC_NO,  KC_NO,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_NO, KC_NO,
